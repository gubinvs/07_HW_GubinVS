...
namespace _07_HW_GubinVS_2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Print("Введите начальную дату записи для экспорта в формате: гггг,мм,дд");
            //string data = Console.ReadLine();

            Print("Введите конечную дату записи для экспорта в формате: гггг,мм,дд");
            //string data2 = Console.ReadLine();


            // Удаление элементв списка не входящих в выбранный диапазон
            db.Export(new DateTime(2021,03,01), new DateTime(2021,06,01));
