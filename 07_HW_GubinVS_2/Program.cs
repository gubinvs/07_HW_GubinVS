...
namespace _07_HW_GubinVS_2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Print("Введите начальную дату записи для экспорта в формате: дд.мм.гггг");
            string data = "04.02.2021";  // Console.ReadLine();

            Print("Введите конечную дату записи для экспорта в формате: дд.мм.гггг");
